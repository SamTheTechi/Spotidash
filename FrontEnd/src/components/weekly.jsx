...
const Weekly = () => {
  ...
  return (
    <>
      <div className='border-[5px] border-[rgba(0,0,0,0.1)] rounded-[15px]  flex justify-center items-center overflow-hidden m-1.5  hover:shadow-customWhiteShadow bg-pink-400'>
        <Link to={`weekly`}>
          <img
            src={res}
            alt='Discover Weekly'
