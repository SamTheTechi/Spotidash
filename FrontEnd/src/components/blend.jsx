...
const Blend = () => {
  ...
  return (
    <>
      <div className='border-[5px] hover:shadow-customWhiteShadow border-[rgba(0,0,0,0.1)] rounded-[15px]  flex justify-center items-center overflow-hidden m-1.5 bg-yellow-500'>
        <Link to={`blend`}>
          <img
            src={res}
            alt='Blends'
